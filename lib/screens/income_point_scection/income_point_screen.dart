...
class IncomePointScreen extends StatelessWidget {
  const IncomePointScreen({super.key});
  ...
  Widget _buildMenuItems(BuildContext context) {
    ...
    final List<MenuItemData> menuItems = [
      MenuItemData(
        ...
        iconColor: const Color(0xFFEFB302), // Orange color
        title: 'আপনার ইনকাম হিস্ট্রি দেখুন',
        onTap: () {
          // Navigate to withdrawal history
        },
      ),
      MenuItemData(
        assetIcon: 'assets/icons/withdraw.png',
        iconColor: const Color(0xFFEFB302), // Orange color
        title: 'ইনকাম পয়েন্টস উত্তোলন করুন',
        onTap: () {
      ...
      MenuItemData(
        assetIcon: 'assets/icons/history.png',
        iconColor: const Color(0xFFEFB302), // Orange color
        title: 'ইনকাম পয়েন্টস উত্তোলন হিস্ট্রি',
        onTap: () {
      ...
      MenuItemData(
        ...
        iconColor: const Color(0xFFEFB302), // Orange color
        title: 'ইনকাম পয়েন্টস অ্যাডভান্স পয়েন্টে নিয়ে যান',
        onTap: () {
      ...
      MenuItemData(
        assetIcon: 'assets/icons/history.png',
        iconColor: const Color(0xFFEFB302), // Orange color
        title: 'ইনকাম পয়েন্টস অ্যাডভান্স পয়েন্টে নেওয়ার হিস্ট্রি',
        onTap: () {
          // Navigate to earnings history
        },
      ),
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: Image.asset(
              ...
              errorBuilder: (context, error, stackTrace) {
                ...
                if (item.title.contains('উত্তোলন করুন')) {
                  fallbackIcon = Icons.account_balance_wallet_outlined;
                } else if (item.title.contains('নিয়ে যান')) {
          ...
          trailing: Icon(
            ...
            color: Color(0xFF997300), // Purple arrow color
            size: 20,
          ),
          onTap: item.onTap,
        ),
